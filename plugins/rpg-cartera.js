...
await m.reply(`${who == m.sender ? `Tienes *${user.Dolares} 💵 Dolares* en tu Cartera` : `El usuario @${who.split('@')[0]} tiene *${user.Dolares} 💵 Dolares* en su Cartera`}. `, null, { mentions: [who] })}
