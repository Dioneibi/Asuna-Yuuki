...
const handler = async (m, { conn, command, args, text, usedPrefix }) => {
  ...
  if (command === 'play5') {
    try {
      ...
      if (size >= limit_a2) {
        await conn.sendMessage(m.chat, { text: `[ 🛍️ ] Descargue su audio en:* _${resultados.descargar}_` }, { quoted: m });
        return;
      }
      ...
      try {
        ...
        if (size >= limit_a2) {
          await conn.sendMessage(m.chat, { text: `[ 🛍️ ] Descargue su audio en:* _${audio}_` }, { quoted: m });
          return;
        }
        if (size >= limit_a1 && size <= limit_a2) {
          await conn.sendMessage(m.chat, { document: buff_aud, mimetype: 'audio/mpeg', fileName: ttl + `.mp3` }, { quoted: m });
        ...
        throw '*[ 🛍️ ] O̶c̶u̶r̶r̶i̶ó ̶u̶n ̶e̶r̶r̶o̶r. 𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫, 𝐢𝐧𝐭𝐞́𝐧𝐭𝐚𝐥𝐨 𝐝𝐞 𝐧𝐮𝐞𝐯𝐨 𝐦𝐚́𝐬 𝐭𝐚𝐫𝐝𝐞.*';
      }
    }
  }
  ...
  if (command === 'play6') {
    try {
      ...
      if (size2 >= limit2) {
        await conn.sendMessage(m.chat, { text: `*[ 🛍️ ] Descargue su vídeo en:* _${resultados.descargar}_` }, { quoted: m });
        return;
      }
      ...
      try {
        ...
        if (size2 >= limit2) {
          await conn.sendMessage(m.chat, { text: `*[ 🛍️ ] Descargue su vídeo en:* _${video}_` }, { quoted: m });
          return;
        }
        if (size2 >= limit1 && size2 <= limit2) {
          await conn.sendMessage(m.chat, { document: buff_vid, mimetype: 'video/mp4', fileName: ttl2 + `.mp4` }, { quoted: m });
        ...
        throw '*[ 🛍️ ] ̶O̶̶c̶̶u̶̶r̶̶r̶̶i̶̶ó ̶̶u̶̶n ̶̶e̶̶r̶̶r̶̶o̶̶r. 𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫, 𝐢𝐧𝐭𝐞́𝐧𝐭𝐚𝐥𝐨 𝐝𝐞 𝐧𝐮𝐞𝐯𝐨 𝐦𝐚́𝐬 𝐭𝐚𝐫𝐝𝐞.*';
      }
    }
  }
};
