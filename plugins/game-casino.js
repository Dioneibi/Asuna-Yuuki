...
if (args.length < 1) return conn.reply(m.chat, '🤍 Ingresa la cantidad de ' + `💵 *Dolares*` + ' que deseas aportar contra' + ` *Asuna-Yuuki*` + `\n\n` + '`Ejemplo:`\n' + `> *${usedPrefix + command}* 100`, m, rcanal)
if (user.Dolares >= count * 1) {
