...
${chalk.cyan('❚')} ${chalk.cyan('𝐇𝐎𝐑𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.black(chalk.bgBlue('%s'))} 
${chalk.cyan('❚')} ${chalk.cyan('𝐏𝐄𝐒𝐎 ❱❱')} ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.cyan('❚')} ${chalk.cyan('𝐔𝐒𝐔𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.redBright('%s')} ${chalk.blueBright('en')} 
${chalk.cyan('❚')} ${chalk.cyan('𝐋𝐔𝐆𝐀𝐑 ❱❱')} ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.cyan('❚')} ${chalk.cyan('𝐓𝐈𝐏𝐎 ❱❱')} ${chalk.white('[Texto]')}
