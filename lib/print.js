...
${chalk.whiteBright('❚')} ${chalk.cyan('𝐁𝐎𝐓 ❱❱')} ${chalk.cyan('%s')} ⏱️ ${chalk.black(chalk.bgBlue('%s'))} 📂 ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.whiteBright('❚')} ${chalk.redBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.whiteBright('❚')} ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
