...
${chalk.white('❚')} ${chalk.cyan('𝐁𝐎𝐓 ❱❱')} ${chalk.cyan('%s')} 
${chalk.white('❚')} ${chalk.cyan('𝐇𝐎𝐑𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.black(chalk.bgBlue('%s'))} 
${chalk.white('❚')} ${chalk.cyan('𝐏𝐄𝐒𝐎 ❱❱')} ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.white('❚')} ${chalk.cyan('𝐔𝐒𝐔𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.redBright('%s')} ${chalk.blueBright('en')} 
${chalk.white('❚')} ${chalk.cyan('𝐋𝐔𝐆𝐀𝐑 ❱❱')} ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.white('❚')} ${chalk.cyan('𝐓𝐈𝐏𝐎 ❱❱')} ${chalk.greenBright.bold('[%s]')}
${chalk.cyan('𝄢 · • —– ٠ ✤ ٠ —– • · · • —– ٠ ✤ ٠ —– • ·✧༄')}`.trim(), 
