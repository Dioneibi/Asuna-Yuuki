...
export default async function (m, conn = { user: {} }) {
 ...
 console.log(`${chalk.whiteBright('𝄢 · • —– ٠ ✤ ٠ —– • · · • —– ٠ ✤ ٠ —– • ·✧༄')}
${chalk.whiteBright('❚')} ${chalk.cyan('𝐁𝐎𝐓 ❱❱')} ${chalk.cyan('%s')}
${chalk.whiteBright('❚')} ${chalk.cyan('𝐇𝐎𝐑𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.whiteBright('❚')} ${chalk.cyan('𝐏𝐄𝐒𝐎 ❱❱')} ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.whiteBright('❚')} ${chalk.cyan('𝐔𝐒𝐔𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.redBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.whiteBright('❚')} ${chalk.cyan('𝐋𝐔𝐆𝐀𝐑 ❱❱')} ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.whiteBright('𝄢 · • —– ٠ ✤ ٠ —– • · · • —– ٠ ✤ ٠ —– • ·✧༄')}`.trim(), 
